    ...
    <div class="app-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" data-page="resource-library">
                        <i class="fas fa-book"></i>
                        <span>Resource Library</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" data-page="wynfull-ai">
                        <i class="fas fa-robot"></i>
                        <span>Wynfull AI</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" data-page="coaching">
                        <i class="fas fa-user-tie"></i>
                        <span>Coaching</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" data-page="messaging">
            ...
            <div class="sidebar-footer">
                <div class="user-info" onclick="showPage('account')" style="cursor: pointer;">
                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face&auto=format" alt="User Avatar" class="user-avatar">
                    <div class="user-details">
                        <span class="user-name">Femi</span>
                        <span class="user-role">Financial Freedom Plus Member</span>
                    </div>
                    <button class="role-switch-btn" id="roleSwitchBtn" title="Switch to Coach View">
                        <i class="fas fa-user-tie"></i>
                    </button>
                </div>
            </div>
        ...
        <main class="main-content">
            ...
            <div id="resource-library" class="page">
                <div class="page-content">
