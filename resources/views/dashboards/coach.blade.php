            ...
            <div class="page-content">
                ...
                <div class="schedule-controls">
                    <div class="schedule-nav">
                        ...
                        <button class="nav-btn" data-view="month">Month View</button>
                        <button class="nav-btn" data-view="day">Day View</button>
                    </div>
                ...
                <div class="schedule-calendar">
                    ...
                    <div class="calendar-grid">
                        <div class="calendar-day">
                            ...
                            <div class="day-sessions">
                                <div class="session-block">
                                    ...
                                    <div class="session-client">John Doe</div>
                                    <div class="session-type">Financial Review</div>
                                    <button class="btn-secondary join-call">
                                ...
                                <div class="session-block">
                                    ...
                                    <div class="session-client">Maria Rodriguez</div>
                                    <div class="session-type">Debt Strategy</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="calendar-day">
                            ...
                            <div class="day-sessions">
                                <div class="session-block">
                                    <div class="session-time">11:00 AM</div>
                                    <div class="session-client">Lisa Wang</div>
                                    <div class="session-type">Home Buying</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="calendar-day">
                            ...
                            <div class="day-sessions">
                                <div class="session-block">
                                    ...
                                    <div class="session-client">David Kim</div>
                                    <div class="session-type">Business Planning</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="calendar-day">
                            ...
                            <div class="day-sessions">
                                <div class="session-block">
                                    ...
                                    <div class="session-client">New Client</div>
                                    <div class="session-type">Initial Consultation</div>
                                </div>
                            </div>
                        </div>
                    </div>
