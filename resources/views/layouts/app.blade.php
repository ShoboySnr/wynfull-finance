        ...
        <header class="top-header">
            <div class="header-left">
                <div class="header-breadcrumb">
                    <span class="breadcrumb-item">@yield('breadcrumb', 'Coach Dashboard')</span>
                </div>
                <div class="header-title-section">
                    <h1 class="page-title">@yield('page-title', 'Dashboard')</h1>
                    <p class="page-subtitle">@yield('page-subtitle', 'Manage your clients and coaching sessions')</p>
                </div>
            </div>
            <div class="header-right">
                <div class="header-user-info" id="userDropdownToggle">
                    ...
                    <div class="user-avatar-container">
                        ...
                        <div class="user-status-indicator coach-status"></div>
                    </div>
