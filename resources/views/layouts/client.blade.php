...
<body class="antialiased" data-user-role="client">
        ...
        <header class="top-header">
            <div class="header-left">
                <div class="header-breadcrumb">
                    <span class="breadcrumb-item">@yield('breadcrumb', 'Client Dashboard')</span>
                </div>
                <div class="header-title-section">
                    <h1 class="page-title">@yield('page-title', 'Dashboard')</h1>
                    <p class="page-subtitle">@yield('page-subtitle', 'Ready to continue your financial journey?')</p>
                </div>
            </div>
            <div class="header-right">
                <div class="header-user-info" id="userDropdownToggle">
                    ...
                    <div class="user-avatar-container">
                        <img src="{{ auth()->user()->profile?->avatar_url ?? 'https://placehold.co/40x40/EBF0FF/0E4DA4?text=' . strtoupper(substr(auth()->user()->name, 0, 1)) }}" 
                             alt="User Avatar" class="header-user-avatar">
                        <div class="user-status-indicator client-status"></div>
                    </div>
                    <div class="user-dropdown" id="userDropdown">
                        <a href="{{ route('account.client') }}" class="dropdown-item">
